...
var DEFAULT_TOOLBOX = {
    ...
    data: [{
        ...
        primary: 0,
        secondary: [
            {cid:TOOL_ID.RECT,name:'矩形',icon:rectIcon, className:'rect', drawRect:true, param: {'shapeWidth': 100, 'shapeHeight': 100,  'fillColor':'#3899ec'}},
            {cid:TOOL_ID.ELLIPSE,name:'椭圆',icon:ellipseIcon, className:'ellipse', drawRect:true, param: {'shapeWidth': 100, 'shapeHeight': 100,  'fillColor':'#3899ec'}},
        ...
        primary: 0,
        secondary: [
            {cid:TOOL_ID.HTML,name:'网页',icon:htmlIcon, className:'html', drawRect:true, param:{'shapeWidth': 100, 'shapeHeight': 100, 'shapeResize': true}},
    ...
    //         {cid:TOOL_ID.FILE,name:'文件',icon:fileIcon, className:'file'}]
        ...
        primary: 0,
        secondary: [
            {cid:TOOL_ID.FLEX,name:'相对定位容器',icon:flexIcon, className:'flex', param: {'width': '100%', 'height': '100%','widthisRate':true,'heightisRate':true,'alignItems':'flex-start'}},
            ...
            {cid:TOOL_ID.DOM,name:'绝对定位容器',icon:domIcon, className:'dom', param:{'width': '100%', 'height': '100%','widthisRate':true,'heightisRate':true}}
        ]
    // },{
    //     name:'画布',
    //     key:13,
