...
propertyMap['world'] = [
    ...
    { name: 'autoGravity',showName:'自动计算重力方向', type: propertyType.Boolean,group:'tools2', default: false, isProperty: true },
    { name: 'gravityX',showName:'水平重力', type: propertyType.Number,group:'tools2', default: 0, isProperty: true },
    { name: 'gravityY',showName:'垂直重力', type: propertyType.Number,group:'tools2', default: 100, isProperty: true },
    { name: 'border',showName:'边界宽度', type: propertyType.Integer,group:'tools2', default: 100, isProperty: true },
    { name: 'northWall',showName:'北墙', type: propertyType.Boolean,group:'tools3', default: true, isProperty: true },
    { name: 'southWall',showName:'南墙',  type: propertyType.Boolean,group:'tools3', default: true, isProperty: true },
    { name: 'westWall', showName:'西墙', type: propertyType.Boolean,group:'tools3', default: true, isProperty: true },
    { name: 'eastWall',showName:'东墙',  type: propertyType.Boolean,group:'tools3', default: true, isProperty: true },
    { name: 'play', showName:'播放', isFunc: true },
    { name: 'pause', showName:'暂停', isFunc: true },
...
propertyMap['body'] = [
    ...
    { name: 'mass', showName:'质量', type: propertyType.Number,group:'tools2',  default: 0, isProperty: true },
    { name: 'globalVx', type: propertyType.Number, group:'tools2', default: 0, isProperty: true },
    { name: 'globalVy', type: propertyType.Number,group:'tools2',  default: 0, isProperty: true },
    { name: 'velocityX',showName:'水平方向速度',  type: propertyType.Number, group:'tools2', default: 0, isProperty: true },
    { name: 'velocityY',showName:'垂直方向速度',  type: propertyType.Number,group:'tools2',  default: 0, isProperty: true },
    { name: 'angularVelocity',showName:'初始角速度', type: propertyType.Number,group:'tools2',  default: 0, isProperty: true },

    { name: 'fixedX',showName:'固定x坐标', type: propertyType.Boolean, default: false, group:'tools2', isProperty: true },
    { name: 'fixedY', showName:'固定y坐标',type: propertyType.Boolean, default: false, group:'tools2', isProperty: true },
    { name: 'fixedRotation',showName:'固定旋转角度', type: propertyType.Boolean, default: false,group:'tools2',  isProperty: true },
    { name: 'damping',showName:'阻尼', type: propertyType.Number, default: 0.1,group:'tools3',  isProperty: true },
    { name: 'angularDamping',showName:'角度阻尼',  type: propertyType.Number, default: 0.1, group:'tools3', isProperty: true },
    { name: 'collisionResponse',showName:'碰撞反应',  type: propertyType.Boolean, default: true, group:'tools3', isProperty: true },
    { name: 'isCircle', showName:'圆形边界', type: propertyType.Boolean, default: false,group:'tools3',  isProperty: true },
    { name: 'detectionDepth', showName:'深度探测', type: propertyType.Integer, default: 2,group:'tools3',  isProperty: true },
