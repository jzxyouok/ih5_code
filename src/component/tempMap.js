...
let propMapping = {
    ...
    'flexDirection': {name:'flexDirection', showName:'主轴方向', type: propertyType.Select, default: '上下',options:{'上下':'column','下上':'column-reverse','左右':'row', '右左':'row-reverse'},group:'tools3'},
    'justifyContent': {name:'justifyContent', showName:'主轴对齐', type: propertyType.Select, default:'flex-start', options:{'靠前':'flex-start','靠后':'flex-end','居中':'center', '均分（靠边）':'space-between','均分（不靠边）':'space-end'},group:'tools3'},
