    ...
    constructor (props) {
        ...
        this.panels = [
            {name:'基础组件',key:1,cplist: [
                ...
                {cid:this.cid++,icon:"slidetimerIcon", className:'slidetimer', drawRect:true, param: {'shapeWidth': 300, 'shapeHeight': 300, 'lineWidth':0, 'fillColor':'transparent', 'totalTime': 10, 'shapeResize': true}},
                ...
                {cid:this.cid++,icon:"htmlIcon", className:'html', drawRect:true, param:{'shapeWidth': 100, 'shapeHeight': 100, 'shapeResize': true}},
                {cid:this.cid++,icon:"pageIcon", className:'page'},
                {cid:this.cid++,icon:"pageContainerIcon", className:'pagecontainer',param: {'width': 200, 'height': 200, 'shapeResize': true}},
